 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Matt Schmidt");
		  toPrint += p1.toString("902885689");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Mark Owens");
		  toPrint += p2.toString("902911206");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Brandon Levester");
		  toPrint += p3.toString("902820166");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Alexander Ulan Hernandez");
                  toPrint += p4.toString("902791677");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Victoria Palacios");
                  toPrint += p5.toString("902860213");
		  //Person6 replace P6 with your name
		  //and gburdell3 with your gt id
		  Person6 p6 = new Person6("Aziz Somani");
		  toPrint += p6.toString("902860225");
